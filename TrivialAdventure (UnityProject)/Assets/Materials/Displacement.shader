...
Shader "Custom/displacement"
{
	Properties
	{
		...
		_Wavelength("Wave length", Range( 0.05 , 20)) = 10
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 panner15 = ( 1.0 * _Time.y * float2( 0.05,0.1 ) + uv_TexCoord14);
			float2 panner16 = ( 1.0 * _Time.y * float2( -0.1,-0.08 ) + uv_TexCoord14);
...
/*ASEBEGIN
Version=15700
1440;92;480;926;397.954;349.4456;1;False;False
Node;AmplifyShaderEditor.RangedFloatNode;9;-1968.901,38.79998;Float;False;Property;_Wavelength;Wave length;11;0;Create;True;0;0;False;0;10;10;0.05;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;14;-1665.841,21.45434;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;15;-1383.741,13.65433;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0.05,0.1;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;16;-1396.807,503.321;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;-0.1,-0.08;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-501.5004,762.0992;Float;False;Property;_Amplitude;Amplitude;12;0;Create;True;0;0;False;0;0;0.5;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;11;-290.0001,86.7;Float;False;Property;_Smoothness;Smoothness;10;0;Create;True;0;0;False;0;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;10;-465.8999,-246.9;Float;False;Property;_Color;Color;5;1;[HDR];Create;True;0;0;False;0;0.08018869,0.6248133,1,0;0,2.070755,43.00032,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=4661FCEB7C0160A17A9B7AE08F565C812F142F35